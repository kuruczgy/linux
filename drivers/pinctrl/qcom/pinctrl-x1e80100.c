...
static const struct msm_pingroup x1e80100_groups[] = {
	...
	[192] = PINGROUP(192, _, _, _, _, _, _, _, _, _), /* LPASS_0 swr_tx_clk */
	[193] = PINGROUP(193, _, _, _, _, _, _, _, _, _), /* LPASS_1 swr_tx_data0 */
	[194] = PINGROUP(194, _, _, _, _, _, _, _, _, _), /* LPASS_2 swr_tx_data1 */
	[195] = PINGROUP(195, _, _, _, _, _, _, _, _, _), /* LPASS_3 swr_rx_clk */
	[196] = PINGROUP(196, _, _, _, _, _, _, _, _, _), /* LPASS_4 swr_rx_data0 */
	[197] = PINGROUP(197, _, _, _, _, _, _, _, _, _), /* LPASS_5 swr_rx_data1 */
	[198] = PINGROUP(198, _, _, _, _, _, _, _, _, _), /* LPASS_6 dmic_clk_soc */
	[199] = PINGROUP(199, _, _, _, _, _, _, _, _, _), /* LPASS_7 dmic_data_soc */
	[200] = PINGROUP(200, _, _, _, _, _, _, _, _, _), /* LPASS_8 dmic2_clk */
	[201] = PINGROUP(201, _, _, _, _, _, _, _, _, _), /* LPASS_9 dmic2_data */
	[202] = PINGROUP(202, _, _, _, _, _, _, _, _, _), /* LPASS_10 WSA_SWR_CLK */
	[203] = PINGROUP(203, _, _, _, _, _, _, _, _, _), /* LPASS_11 WSA_SWR_DATA */
	[204] = PINGROUP(204, _, _, _, _, _, _, _, _, _), /* LPASS_12 WSA0_EN */
	[205] = PINGROUP(205, _, _, _, _, _, _, _, _, _), /* LPASS_13 WSA1_EN */
	[206] = PINGROUP(206, _, _, _, _, _, _, _, _, _), /* LPASS_14 swr_tx_data2 */
	[207] = PINGROUP(207, _, _, _, _, _, _, _, _, _), /* LPASS_15 WSA2_SWR_CLK/i2s2 */
	[208] = PINGROUP(208, _, _, _, _, _, _, _, _, _), /* LPASS_16 WSA2_SWR_DATA/i2s2 */
	[209] = PINGROUP(209, _, _, _, _, _, _, _, _, _), /* LPASS_17 dmic4/i2s3 */
	...
	[214] = PINGROUP(214, _, _, _, _, _, _, _, _, _), /* LPASS_22 */
